        ...
        {cards.map((card) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col rounded-xl border border-border bg-card p-6 shadow-sm outline-none transition-all duration-200 hover:-translate-y-0.5 hover:border-ring hover:shadow-lg focus-visible:ring-1 focus-visible:ring-ring"
            >
